...
public class LoginVKFragment extends ArtekFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        super.init(false);
        return inflater.inflate(ru.temoteam.artek.app.R.layout.fragment_login_vk, container, false);
    }
    ...
    public void getUserData(String url) {
        ...
        getFragmentManager().beginTransaction().replace(ru.temoteam.artek.app.R.id.frgmCont, new NewsFragment()).commit();
    }
