...
public class RecyclerTipsAdapter extends RecyclerView.Adapter<RecyclerTipsAdapter.ViewHolder> {
    ...
    public RecyclerTipsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(ru.temoteam.artek.app.R.layout.recycler_item_tip, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (tip.containsKey("img"))
            ...
            holder.ava.setImageResource(ru.temoteam.artek.app.R.drawable.artek);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            super(v);
            name = (TextView) v.findViewById(ru.temoteam.artek.app.R.id.name);
            text = (TextView) v.findViewById(ru.temoteam.artek.app.R.id.text);
            ava = (ImageView) v.findViewById(ru.temoteam.artek.app.R.id.ava);
            ratingBar = (RatingBar) v.findViewById(ru.temoteam.artek.app.R.id.rete_bar);
        ...
        public void showRatingDialog() {
            ...
            View linearlayout = activity.getLayoutInflater().inflate(ru.temoteam.artek.app.R.layout.dialog_rating, null);
            dialogRating = (RatingBar) linearlayout.findViewById(ru.temoteam.artek.app.R.id.ratingbar);
